...
原始查询: 为什么大学生喜欢旷课?
优化查询: 大学生旷课的普遍原因及其背后的心理和社会因素有哪些？如何从教育制度、课程设置和学生个人动机等多角度分析这一现象？

最终回答:
大学生旷课是一个复杂的教育现象，其背后涉及个体心理、社会文化、教育制度等多重因素的交互作用。以下从多个维度进行系统分析：
...
def run_example_workflow():
    ...
    # 4. 定义初始输入
    initial_input = {"user_query": "为什么大学生喜欢旷课?"}
